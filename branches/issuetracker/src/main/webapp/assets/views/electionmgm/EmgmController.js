(function () {
	'use strict';
	angular.module('issuetracker').controller('EmgmController',['$scope','$rootScope','$http', '$exceptionHandler', '$timeout','$location','AdminService','GraphHelper','NgMap','AppConstants',function ($scope,$rootScope,$http,$exceptionHandler, $timeout,$location,AdminService,GraphHelper,NgMap,AppConstants) {
