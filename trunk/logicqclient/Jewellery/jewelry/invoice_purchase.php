...
$pdf->Cell(70, 5,'REQUESITION ORDER',0,1);
...
$pdf->Cell(70, 5,'REQUESITION INVOICE#',0,1);
#$pdf->Cell(, 5,$invoiceno,0,1);

$pdf->Cell(120, 5,'Fax [+91-20-12548765]',0,0);
$pdf->Cell(40, 5,$invoiceno,0,1);
#$pdf->Cell(45, 5,$requestnid,0,1);
...
$pdf->Cell(30, 5,'Requestion. ID',0,0,'C');
$pdf->Cell(30, 5,'Seller ID',0,0,'C');
$pdf->Cell(45, 5,'Item Dec.',0,0);
$pdf->Cell(25, 5,'Caret',0,0,'C');
$pdf->Cell(25, 5,'Weight',0,0,'C');
