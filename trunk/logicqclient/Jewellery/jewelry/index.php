...
<div class="home-popular-collections">
  ...
  <h6 class="general-title contact-footer-title">Promising Stuffs</h6>
  ...
  <div id="widget-newsletter">
    <div class="container">      
	  ...
	  <div class="newsletter col-md-24">
		<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Send SMS</button>
      </div> 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="send_sms.php" method="post" id="sendsms">
          <div class="form-group">
            <label for="recipient-mobile" class="form-control-label">Recipient Mobile:</label>
            <input type="text" class="form-control" id="recipient-name">
          </div>
          <div class="form-group">
            <label for="message-text" class="form-control-label">Message Content:</label>
