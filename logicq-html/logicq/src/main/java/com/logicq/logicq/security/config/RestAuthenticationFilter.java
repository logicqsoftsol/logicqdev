...
public class RestAuthenticationFilter extends GenericFilterBean {
		...
		try {
			...
			if (!StringUtils.isEmpty(token)) {
				...
				String password = (String) httpRequest.getHeader("password");
				 ...
				 final String authtoken= tokenAuthenticationService.getTokenHandler().createTokenForUser((LoginUserVO) userDetails);
	...
	public void SetResponse(HttpServletResponse httpResponse, HttpStatus message, Integer responsecode, Exception ex) throws IOException {
