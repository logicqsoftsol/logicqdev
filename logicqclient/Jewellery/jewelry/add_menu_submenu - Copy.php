...
<div class="wrapper">
 ...
 <div class="panel-body">
	...
	<p><span class="error"> Enter New Sub Menus</span></p>
 

 <form method="post" action="add_menu.php" id="add_menu">  
  <div class="row">
	<div class="col-xs-6 col-sm-6 col-md-6"> 
			<div class="form-group">
...
<?php 
								...
								error_reporting( ~E_NOTICE );
								 ...
								 $stmt = $DB_con->prepare('SELECT id, name, displayname FROM menu_details ORDER BY id ASC');
								 $stmt->execute();
...
?>
<option value="<?php echo $row['id']; ?>"><?php $row['displayname']; ?></option>
...
<?php 
 ...
 ?>
			...
			<div class="form-group">
				<button type="submit" name="add_menu" class="btn btn-default"> ADD Menu </button>
